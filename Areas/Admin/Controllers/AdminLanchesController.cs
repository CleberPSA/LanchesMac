...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string filter, 
            int pageindex=1, string sort="Nome")
        {
            ...
            var model = await PagingList.CreateAsync(resultado, 3, pageindex,
                sort, "Nome");
        ...
        public async Task<IActionResult> Create([Bind("LancheID,Nome,DescricacoCurta,DescricacoDetalhada,Preco,ImageURL,ImagemThumbnaiUrl,IsLanchePreferido,EmEstoque,CategoriaID")] Lanche lanche)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheID,Nome,DescricacoCurta,DescricacoDetalhada,Preco,ImageURL,ImagemThumbnaiUrl,IsLanchePreferido,EmEstoque,CategoriaID")] Lanche lanche)
        {
